            ...
            mAuth!!
                    ...
                    .addOnCompleteListener(this) { task ->
                        ...
                        if (task.isSuccessful) {
                            ...
                            Toast.makeText(this@CreateAccountActivity, "Autentificación fallida.",
                ...
                .addOnCompleteListener(this) { task ->
                    if (task.isSuccessful) {
                        Toast.makeText(this@CreateAccountActivity,
                                "Verificación de email enviado a: " + mUser.getEmail(),
                                Toast.LENGTH_SHORT).show()
                    } else {
                        Log.e(TAG, "sendEmailVerification", task.exception)
                        Toast.makeText(this@CreateAccountActivity,
                                "Fallo en el envío de confirmación de email.",
                                Toast.LENGTH_SHORT).show()
                    }
                }
    }
